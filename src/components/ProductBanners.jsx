...
import img4 from "../assets/banners/b-4.png";
import img5 from "../assets/banners/b-5.png";
import img6 from "../assets/banners/b-6.png";
...
const ProductBanners = () => {
  ...
  const desktopImg = [img1, img4, img5, img6];
  ...
  return (
    <div className=" container mx-auto px-4 rounded">
      <div className=" h-60 md:h-96 w-full bg- bg-yellow-400 mx-auto rounded-lg relative">
        ...
        <div className="hidden md:flex w-full h-full overflow-hidden">
          {desktopImg.map((imgUrl, index) => {
            return (
              <div
                className="w-full h-full  min-w-full min-h-full trasnlate overflow-hidden transition-all"
                key={imgUrl}
