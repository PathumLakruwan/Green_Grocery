            ...
            allUsers.map((el,index) =>{
              return(
                <tr>
                  ...
                  <td>
                    <button className='rounded-xl cursor-pointer hover:bg-blue-100' 
                      onClick={()=> {
...
//<div className='w-80 h-40 bg-purple-700 fixed mx-auto items-center justify-center z-10 rounded-'></div>