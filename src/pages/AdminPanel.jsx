        ...
        <div className=' h-36 bg-purple-300 flex justify-center items-center flex-col'>
          ...
          <div>
            <nav className= ' grid font-semibold text-sm justify-center flex-col items-center '>
              <Link to={'/allUsers'} className=' px-2 py-1 hover:bg-purple-500 rounded-full'>All Users</Link>
              <Link to={'/allProducts'} className=' px-2 py-1 hover:bg-purple-500 rounded-full'>All Products</Link>
            </nav>
          </div>
        </div>
    </aside>

    <main className='bg-green-400 min-h-full w-full' >
        <Outlet/>
    </main>
